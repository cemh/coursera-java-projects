...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int  compareTo(EarthquakeMarker other)
	{
		...
		return new Float( other.getMagnitude() ).compareTo(this.getMagnitude());
		//you could return -1,0 or 1 depending on the float comparison of the magnitudes.
		//instead i changed the types.
	}
	
	/**
	 * 
	 * If you want to use Collections.sort, 
	 * you will need to create a List<EarthquakeMaker>, and with a loop,
	 *  add the earthquakes from quakeMarker to the new list of EarthquekeMakers.
