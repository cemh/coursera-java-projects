...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
		...
		//double clicking and panning on map: adding interactivity.
	...
	private void shadeCountries() {
		for (Marker marker : countryMarkers) {
			...
			//there could be a country not listed in lifeExp data.
			//marker and lifeExp data should match. if not it is grey.
