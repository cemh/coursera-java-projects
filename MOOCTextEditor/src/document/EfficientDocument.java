...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		//This method should make ONE pass through the tokens list and count the number of words, 
		//sentences and syllables in the document. 
		//It should store these values in the appropriate member variables so that when the method is over,
